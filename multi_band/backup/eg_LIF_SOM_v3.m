...
% param_som.s_ee     = 0.0180 *100 /alpha*beta / param_som.p_ee;
% param_som.s_ie     = 0.0750 *100 /alpha*beta / param_som.p_ie;
% param_som.s_ei     = 0.0240 *100 /alpha*beta / param_som.p_ei;
% param_som.s_ii     = 0.0340 *100 /alpha*beta / param_som.p_ii;
% param_som.s_si     = 0.0340 *100 /alpha*beta / param_som.p_si;
% param_som.s_es     = 0.0155 *100 /alpha*beta / param_som.p_es;
% param_som.s_se     = 0.0430 *100 /alpha*beta / param_som.p_se;
% param_som.s_is     = 0.0250 *100 /alpha*beta / param_som.p_is;
% param_som.s_exe    = 1;
% param_som.s_exi    = 1;
% param_som.s_exs    = 1;
...
param_som.s_se     = 2.00*0.500 /alpha*beta / param_som.p_se;
